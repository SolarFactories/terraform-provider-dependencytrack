...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("dependencytrack_user.test", "password", "Test_Password"),
					resource.TestCheckResourceAttr("dependencytrack_user.test", "suspended", "false"),
					resource.TestCheckResourceAttr("dependencytrack_user.test", "force_password_change", "false"),
					resource.TestCheckResourceAttr("dependencytrack_user.test", "password_expires", "false"),
				),
			},
			// ImportState testing.
			{
				ResourceName:            "dependencytrack_user.test",
				ImportState:             true,
