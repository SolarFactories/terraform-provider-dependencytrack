...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.dependencytrack_config_property.test", "description", "URL used to construct links back to Dependency-Track from external systems"),
				),
			},
		},
	})
